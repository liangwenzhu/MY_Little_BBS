...
if($selectResultRow > 0){
    ...
    $sql = "insert into Jubao(jubaoType,tieziId,gentieId,jubaoUserName,beijubaoUserName,jubaoDate) values ('$jubaoType','$tieziId','$gentieId','$userName','$beijubaoUserName',now())";
