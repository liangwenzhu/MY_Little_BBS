<template>
    <div class="jubaoManageRouter">
        <!--嵌套路由开始-->
        <div class="introduce">
          <router-link to="/jubaoManage/tiezi"><span>帖子举报</span></router-link>
          <router-link to="/jubaoManage/gentie"><span class="active">跟帖举报</span></router-link>
            <simpleRoDetail></simpleRoDetail>
            <b class="loadCount">已全部加载，共<b class="light">{{jubaoObj.length}}</b>条记录</b>
        </div>
        ...
        <div class="flex-title">
            ...
            <span >被举报跟帖ID</span>
            <span>被举报用户</span>
            <span v-show="ifShowDetail" class="date">跟帖创建日期</span>
            <span>举报人</span>
  ...
  import noRecord from "../tips/noRecord.vue"
    export default {
        ...
        created(){
            ...
            $.ajax({
                url:"php/backend/gentiejubaoSelect.php",
                data:{
                  jubaoType:jubaoType
                },
                type:"post",
