<template>
    <div class="backendContent">
        ...
        <div class="flex-title">
          <span>序号</span>
          <span>板块ID</span>
          <span  class="date">板块名</span>
          <span>版主数</span>
          <span class="date">板块创建日期</span>
          <span>板块详情及管理</span>
        </div>
...
<script>
  import managerApplyContent from '../four/sectionManageContent.vue'
  ...
  import noRecord from "../tips/noRecord.vue"
    export default {
      ...
      created(){
        var that = this;
        $.ajax({
          url:"php/backend/sectionSelect.php",
          type:"post",
          dataType:"json",
